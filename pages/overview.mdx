...
Get a high-level overview of LYTS and its design choices.
...
When working with flexbox in can be confusing on which axis alignItems and justifyContent operates. When `flexDirection` is "row" ... when ... is .... LYTS normalizes this into "xAlign" and "zAlign" props which can be used on all of the components. Of course, manually supplying alignItems/justifyContent still works as expected.
