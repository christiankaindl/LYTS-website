---
title: Overview
description: What has LYTS to offer for you?
---
...
Getting to your desired layout should be as straightforward as possible. That's why LYTS exposes layout-speciic functionality as props on its components. In addition to the domain of each layout component, all components support a few handy props:
...
Most apps and websites use mostly the same types of layout primitives in their design. From navbars, cards, overlays, sidebars, breadcrumbs, etc. Most all of them are easily implemented with LYTS and a lot of them have examples you can copy to your projects.
